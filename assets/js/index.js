const SCRIPT_URL_GLOBAL = "https://script.google.com/macros/s/AKfycby5vsSzTavVN4g1wX-X9bM76ctFzjZY8Uy0IpEzrHrD68Rk2HHLnxkZ_oJCd2KI2Ktz/exec";
        ...
        function goToOtherDashboard(url) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    if (result.value === 'SPVDRESS1' || result.value === 'aksesspvqc') {
                        document.body.style.opacity = '0';
