const URL_SEWING  = "DEMO_MODE_NO_BACKEND";
        const URL_FINISHING = "DEMO_MODE_NO_BACKEND";
        const URL_WASHING  = "DEMO_MODE_NO_BACKEND";
        const URL_AI        = "DEMO_MODE_NO_BACKEND";
        const PASSWORD_SPV = "DEMO";

        // ================= DEMO MODE MOCK BACKEND =================
        (function () {
            const INSPECTORS = {
                SEWING: ['Haura', 'Fitri', 'Nafisah'],
                FINISHING: ['Haura', 'Fitri', 'Nafisah'],
                WASHING: ['Haura', 'Fitri', 'Nafisah']
            };
